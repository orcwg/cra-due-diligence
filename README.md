# ORC WG CRA Due Diligence Whitepaper

This repository contains the White paper on due diligence obligation of manufacturers by
the Cyber Resilience SIG of ORC WG. 
...
The actual text of whitepaper is in the [content] folder. Every chapter of the whitepaper have its own markdown file.  
